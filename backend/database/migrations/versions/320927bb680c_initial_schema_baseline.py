...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('fedimint_secret_code_hash', sa.String(length=64), nullable=True),
        ...
        sa.Column('fedimint_escrow_id', sa.String(length=100), nullable=True),
        sa.Column('fedimint_timeout_block', sa.Integer(), nullable=True),
    ...
    with op.batch_alter_table('deals', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_deals_fedimint_escrow_id', ['fedimint_escrow_id'], unique=False)
