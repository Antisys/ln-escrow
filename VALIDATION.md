...
|---|------|--------|----------------|
| 1 | Create deal on `trustbro.trade` | outstanding | Deal page renders, link generated |
| 2 | Buyer joins via link | outstanding | Buyer page loads, join succeeds |
| 3 | Both parties LNURL-auth with real wallets | outstanding | Ephemeral keys registered, deal activates |
| 4 | Both submit payout addresses (LNURL/LN address) | outstanding | Addresses stored, validated |
| 5 | Buyer funds deal via Lightning | outstanding | Payment received, escrow created in Fedimint |
| 6 | Seller marks shipped | outstanding | Status transitions to shipped |
